    ...
    return (
        <footer className="text-center lg:text-left bg-gray-100 text-gray-600">
          ...
          ">
                            ...
                            CREATED WITH PHOTOGRAPHY
                        </h6>
                        <p>
                            We designed Photography theme to make it works especially for photography. Here are a few included examples that you can import with one click.
                        </p>
                    </div>
                    <div className="">
                        ...
                        <p className="mb-4">
                            <a href="#!" className="text-gray-600">Wedding</a>
                        </p>
                        <p className="mb-4">
                            <a href="#!" className="text-gray-600">Fashion</a>
                        </p>
                        <p className="mb-4">
                            <a href="#!" className="text-gray-600">Picture Perfect Properties</a>
                        </p>
                        <p>
                            <a href="#!" className="text-gray-600">Edible Images</a>
                        </p>
                    </div>
                    <div className="">
                        <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">
            ...
            <div className="text-center p-6 bg-gray-200">
                ...
                <a className="text-gray-600 font-semibold" href="https://tailwind-elements.com/">   LEARN PHOTOGRAPHY</a>
            </div>
        </footer>
    );
};
