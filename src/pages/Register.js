...
const Register = () => {
  const { profileUpdate, signUp } = useContext(AuthContext)
  ...
  return (
    <div className="w-11/12 md:w-7/12 lg:w-5/12 mx-auto my-8   rounded-md  bg-secondary text-neutral ">
      <div className="mb-8 text-center">
        <h1 className="text-4xl font-bold pt-48">Register</h1>
      </div>
      <form
